  ...
  return (
    <div className="mt-8 rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
      ...
      <div className="space-y-3">
        <button type="button" className="btn btn-soft w-full" onClick={() => {
        ...
        <div className="flex w-full gap-2">
          <button type="button" className="btn btn-soft flex-1" onClick={handleRestoreAppOwnerClick}>Restore from Mnemonic</button>
          <button type="button" className="btn btn-soft flex-1" onClick={handleDownloadDatabaseClick}>Download Backup</button>
          <button type="button" className="btn btn-soft flex-1" onClick={handleResetAppOwnerClick}>Reset All Data</button>
        </div>
      </div>
    </div>
  );
