...
export const Schema = {
	user: {
		...
		publicEthereumAddress: String100,
		status: String100,
	},
	channel: {
		id: ChannelId,
	...
	message: {
		...
		signature: NonEmptyString1000, // EIP-712 signature
	},
	reaction: {
		id: ReactionId,
		messageId: MessageId,
...
export const usersQuery = (networkUuid: NonEmptyString100) =>
	evoluInstance.createQuery((db) =>
		db
			.selectFrom("user")
			.select(["id", "displayName", "pfpUrl", "bio", "publicNtfyShId", "status", "publicEthereumAddress"])
