...
export interface CurrentUserData {
	...
	publicEthereumAddress: Hex | null; // Current Ethereum address (for functionality)
}
...
export const UserMessageDataSchema = z.object({
	...
	publicEthereumAddress: z.string().nullable(),
});
...
export interface TextMessage extends BaseWsMessage {
	...
	signature: Hex | null; // signature for signature verification
}
...
export interface DeleteMessage extends BaseWsMessage {
	...
	signature: Hex | null; // signature for signature verification (optional for backwards compatibility)
}
